...
DOM
    - allows to change or update the content of an element in real-time

MULTIPLE SELECTOR
    - selects multiple content by class name, tag, or 
    - stores seleceted elements in an array

innerHTML 
    - treats the content as an HTML element
